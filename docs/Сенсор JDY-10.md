...
Измеренные параметры температуры можно использовать в сценариях управления микроклиматом, включения теплого пола и т.п. Параметры давления интересны в сценариях для метеосувствительных людей: синизть шум, включить расслабляющую музыку и т.п.

...
|Aruino Nano|Для эмуляции USB-RS232|160|

Итоговая стоимость: 590 руб - это в два раза дешевле, чем скромный букет цветов.
...
![График влажности](https://github.com/cutecare/cutecare-docs/blob/master/images/hass-ficus.jpeg)
